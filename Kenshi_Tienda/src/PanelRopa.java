...
public class PanelRopa extends JPanel implements ActionListener {
	...
	public PanelRopa() {
		...
		Object[][] datos = { 
				...
				{"01", "Jersey", "Azul. Cuello redondo", 20+" €", 10, "L", "Algodon", "Hipster"},
				{"02", "Jersey", "Verde. Cuello redondo", 20+" €", 10, "S", "Algodon", "Hipster"},
				{"03", "Jersey", "Rojo. Cuello redondo", 20, 10, "L", "Algodon", "Hipster"},
				{"04", "Jersey", "Azul. Cuello redondo", 20, 10, "L", "Algodon", "Hipster"},
		};	
		
		//Con fotos que te parece??
...
//		table.setEnabled(false);
		...
		textRopa.setBounds(172, 22, 107, 20);
		add(textRopa);
