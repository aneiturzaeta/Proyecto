...
public class PanelComplemento extends JPanel implements ActionListener{
	...
	public PanelComplemento() {
		 ...
		 */
			...
			String[] columnas = {"Codigo","Nombre", "Descripcion", "Precio", "Existencias", "Material", "Orígen"};
			...
			Object[][] datos = { 
					...
					{"11", "Collar", "Gargantilla", 10+" €", 5, "Plata", "Etníco"},
					{"12", "Collar", "Ópera", 16+" €", 5, "Cuerdas", "Hawaiano"},
					{"13", "Bufanda", "Negra", 19,5+" €", 7, "Algodon", "Australiano"},
					{"14", "Pulsera", "Brazalete", 40+" €", 20, "Oro", "Árabe"},
			};	
